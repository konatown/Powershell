...
Input the full path to the CSV containing your list of target users, you may also drag and drop the file into this window. The full path must include the .csv file extension. The document must have one column with the header "User". List the full email addresses of the users under the header.
>'
...
Input the desired permission level
>'
...
Write-Host "Writing calendar permissions for $targetuser"
